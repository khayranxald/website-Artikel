@extends('layouts.app', ['title' => 'Tulis Artikel Baru'])
...
<div class="max-w-4xl mx-auto page-transition">
    ...
    <div class="mb-8 animate-slide-down">
        <h1 class="text-3xl font-bold text-gray-800 dark:text-white mb-2">Tulis Artikel Baru</h1>
        <p class="text-gray-600 dark:text-gray-400">Bagikan pengetahuan dan ide Anda</p>
    </div>
        ...
        <x-glass-card class="mb-6 animate-slide-up delay-100">
            ...
            <div class="mb-6">
                ...
                <textarea 
                    ...
                    name="excerpt" 
                    rows="3"
                    placeholder="Tulis ringkasan singkat artikel (akan otomatis dibuat jika kosong)..."
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-500">Maksimal 500 karakter</p>
                @error('excerpt')
                    <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            </div>
...
- Tambahkan paragraf yang jelas
- Sisipkan gambar jika perlu
